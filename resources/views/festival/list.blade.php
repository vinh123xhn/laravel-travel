                    ...
                    <div class="card-body">
                        <div class="col-sm-12 col-md-6 float-right">
                            <div id="bootstrap-data-table-export_filter" class="dataTables_filter">
                                ...
                                <label>
                                    <a class="btn btn-primary" style="border-radius: 0.2rem; height: 31px; line-height: 20px; margin-bottom:1px; margin-left: 10px" href="{{route('admin.festival.form.get')}}"> Thêm mới lễ hội</a>
                                </label>
                                <label>
                                    <a class="btn btn-warning" style="border-radius: 0.2rem; height: 31px; line-height: 20px; margin-bottom:1px; margin-left: 10px" href="{{route('admin.festival.export')}}"> Xuất dữ liệu</a>
                                </label>
                            </div>
                        </div>
