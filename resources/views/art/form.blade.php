            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                <form action="{{route('admin.art.form.post')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Mã nghệ thuật</label>
                                                <input name="code" type="text" class="form-control" placeholder="Nhập mã nghệ thuật" value="{{old('code')}}">
                                                @error('code')
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class="form-control" placeholder="Nhập tên nghệ thuật" value="{{old('name')}}">
                                            </div>
                                            @error('name')
                                            <p class="danger">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" style="padding-left:0">
                                            <a href="{{route('admin.art.list')}}" class="btn btn-primary  border-radius-5">Quay lại</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
