            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                <form action="{{route('admin.costume.form.update', $costume->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Mã trang phục</label>
                                                <input name="code" type="text" class="form-control" placeholder="Nhập mã trang phục" value="{{old('code') ? old('code') : $costume->code}}">
                                                @error('code')
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class="form-control" placeholder="Nhập tên trang phục" value="{{old('name') ? old('name') : $costume->name}}">
                                                @error('name')
                                                <p class="danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if(isset($costume->image))
                                                    <img id="avatar" style="width: 400px; height: 300px" src="{{asset('storage/'.$costume->image)}}" alt="avatar"/>
                                                @else
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="subtitle" id="editor1">{{old('subtitle') ? old('subtitle') : $costume->subtitle}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="management_unit" type="text" class="form-control" placeholder="Nhập đơn vị quản lý" value="{{old('management_unit') ? old('management_unit') : $costume->management_unit}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="age" type="text" class="form-control" placeholder="Nhập thời kỳ" value="{{old('age') ? old('age') : $costume->age}}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="celebrity" type="text" class="form-control" placeholder="Nhập danh nhân liên quan" value="{{old('celebrity') ? old('celebrity') : $costume->celebrity}}">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Địa điểm liên quan</label>
                                                    <input name="location" type="text" class="form-control" placeholder="Nhập địa điểm liên quan" value="{{old('location') ? old('location') : $costume->location}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="event" type="text" class="form-control" placeholder="Nhập sự kiện liên quan" value="{{old('event') ? old('event') : $costume->event}}">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" style="padding-left:0">
                                            <a href="{{route('admin.costume.list')}}" class="btn btn-primary  border-radius-5">Quay lại</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
