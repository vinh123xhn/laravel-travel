            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                <form action="{{route('admin.cuisine.form.post')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Mã</label>
                                                <input name="code" type="text" class="form-control" placeholder="Nhập mã ẩm thực" value="{{old('code')}}">
                                                @error('code')
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class="form-control" placeholder="Nhập tên ẩm thực" value="{{old('name')}}">
                                                @error('name')
                                                <p class="danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="cook" id="editor2">{{old('cook')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="material" id="editor3">{{old('material')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="space" type="text" class="form-control" placeholder="Nhập không gian" value="{{old('space')}}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Ca múa nhạc</label>
                                                <input name="music" type="text" class="form-control" placeholder="Nhập ca múa nhạc" value="{{old('music')}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="costume" type="text" class="form-control" placeholder="Nhập trang phục" value="{{old('management_unit')}}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Nghi lễ</label>
                                                <input name="ceremony" type="text" class="form-control" placeholder="Nhập nghi lễ" value="{{old('ceremony')}}">
                                            </div>
                                        </div>
                                    </div>
