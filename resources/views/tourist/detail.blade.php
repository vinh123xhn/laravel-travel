            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Chi tiết khách du lịch</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-md-5">
                            ...
                            <a href="{{route('admin.tourist_acommodation.form.edit', $touristAcommodation->id)}}" class="btn btn-primary">Sửa</a>
                        </div>
                    </div>
                </div>
            </div>
