            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                <form action="{{route('admin.crafts.form.update', $crafts->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Mã nghề thủ công</label>
                                                <input name="code" type="text" class="form-control" placeholder="Nhập mã nghề thủ công" value="{{old('code') ? old('code') : $crafts->code}}">
                                                @error('code')
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class="form-control" placeholder="Nhập tên nghề thủ công" value="{{old('name') ? old('name') : $crafts->name}}">
                                                @error('name')
                                                <p class="danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if(isset($crafts->image))
                                                    <img id="avatar" style="width: 400px; height: 300px" src="{{asset('storage/'.$crafts->image)}}" alt="avatar"/>
                                                @else
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="anniversary" type="text" class="form-control" placeholder="Nhập ngày giỗ tổ" value="{{old('anniversary') ? old('anniversary') : $crafts->anniversary}}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Năm công nhận</label>
                                                <input name="year_of_recognition" type="text" class="form-control" placeholder="Nhập năm công nhận" value="{{old('year_of_recognition') ? old('year_of_recognition') : $crafts->year_of_recognition}}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="type_of_crafts_village" class="form-control">
                                                    @foreach(config('base.crafts_village_type') as $k => $item)
                                                        <option
                                                            @if($crafts->type_of_crafts_village == $k)
                                                            {{"selected"}}
                                                            @endif
                                                            value="{{$k}}">{{$item}}
                                                        </option>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="subtitle" id="editor1">{{old('subtitle') ? old('subtitle') : $crafts->subtitle}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="management_unit" type="text" class="form-control" placeholder="Nhập đơn vị quản lý" value="{{old('management_unit') ? old('management_unit') : $crafts->management_unit}}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Danh nhân liên quan</label>
                                                <input name="celebrity" type="text" class="form-control" placeholder="Nhập danh nhân liên quan" value="{{old('celebrity') ? old('celebrity') : $crafts->celebrity}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="location" type="text" class="form-control" placeholder="Nhập địa điểm liên quan" value="{{old('location') ? old('location') : $crafts->location}}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Sự kiện liên quan</label>
                                                <input name="event" type="text" class="form-control" placeholder="Nhập sự kiện liên quan" value="{{old('event') ? old('event') : $crafts->event}}">
                                            </div>
                                        </div>
                                    </div>
